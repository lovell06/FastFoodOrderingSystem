...
public sealed class ForgotPasswordHandler : IHandler<ForgotPasswordCommand, Result<Unit>>
{
    ...
    public async Task<Result<Unit>> HandleAsync(ForgotPasswordCommand command, CancellationToken cancellationToken)
    {
